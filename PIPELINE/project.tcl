...
#
define_hls_module	bubblesort	bubblesort.cc		;# SystemC module to be synthesized
define_hls_config	bubblesort	PIPELINE		;# A synthesis configuration of the hls_module
define_hls_config   bubblesort  PIPELINE_DPA    --dpopt_auto=op,expr
#
# Simulation Configurations
#
define_sim_config B			        {bubblesort BEH}			        ;# A behavioral PIN-level configuration
define_sim_config PIPELINE_V	    {bubblesort RTL_V PIPELINE}      	;# RTL Verilog cosimulation
define_sim_config PIPELINE_DPA_V	{bubblesort RTL_V PIPELINE_DPA}   	;# RTL Verilog cosimulation

######################################################################
# Genus Logic Synthesis Configuration
######################################################################
define_logic_synthesis_config L {bubblesort -all} \
    -options \
        {BDW_LS_NOGATES 1} \
