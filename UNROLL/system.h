...
#include "defines.h"
#include "tb.h"
#include "bubblesort_wrap.h"		// use the generated wrapper for all hls_modules
...
SC_MODULE( System )
{
	...
	bubblesort_wrapper	*m_bubblesort;		// use the generated wrapper for the DUT hls module
	tb		*m_tb;
	...
	, chan2( "chan2" )
	{
		...
		m_bubblesort = new bubblesort_wrapper( "bubblesort_wrapper" );
		m_bubblesort->clk( clk_sig );
		m_bubblesort->rst( rst_sig );
		m_bubblesort->din( chan1 );
		m_bubblesort->dout( chan2 );
