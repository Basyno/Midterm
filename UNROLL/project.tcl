...
define_hls_config	bubblesort	UNROLL		;# A synthesis configuration of the hls_module
define_hls_config   bubblesort  UNROLL_DPA        --dpopt_auto=op,expr
#
# Simulation Configurations
#
define_sim_config B			        {bubblesort BEH}			;# A behavioral PIN-level configuration
define_sim_config UNROLL_V      	{bubblesort RTL_V UNROLL}	;# RTL Verilog cosimulation
define_sim_config UNROLL_DPA_V	    {bubblesort RTL_V UNROLL_DPA}  	;# RTL Verilog cosimulation
