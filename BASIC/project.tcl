...
define_hls_config	bubblesort	BASIC		;# A synthesis configuration of the hls_module
define_hls_config   bubblesort  DPA   
#
# Simulation Configurations
#
define_sim_config B			{bubblesort BEH}			;# A behavioral PIN-level configuration
define_sim_config BASIC_V	{bubblesort RTL_V BASIC}	;# RTL Verilog cosimulation
define_sim_config DPA_V	    {bubblesort RTL_V DPA}	;    # RTL Verilog cosimulation
